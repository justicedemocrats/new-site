...
const debug = __webpack_require__(23)('superagent');
const formidable = __webpack_require__(29);
const FormData = __webpack_require__(32);
const Response = __webpack_require__(43);
const parse = __webpack_require__(2).parse;
const format = __webpack_require__(2).format;
const resolve = __webpack_require__(2).resolve;
let methods = __webpack_require__(17);
const Stream = __webpack_require__(1);
const utils = __webpack_require__(16);
const unzip = __webpack_require__(45).unzip;
const extend = __webpack_require__(47);
const mime = __webpack_require__(48);
...
const pkg = __webpack_require__(52);
const RequestBase = __webpack_require__(53);
const CookieJar = __webpack_require__(6);
...
exports.agent = __webpack_require__(55);
...
exports.parse = __webpack_require__(57);
...
var abort = __webpack_require__(12)
...
var iterate    = __webpack_require__(10)
...
const constructApi = ({ base, username, password }) => {
  ...
  return {
    get: url => _superagent2.default.get(processUrl(url)).auth(username, password),
    post: url => _superagent2.default.post(processUrl(url)).auth(username, password),
    put: url => _superagent2.default.put(processUrl(url)).auth(username, password),
    delete: url => _superagent2.default.delete(processUrl(url)).auth(username, password)
  };
};
...
var IncomingForm = __webpack_require__(30).IncomingForm;
...
var CombinedStream = __webpack_require__(33);
var util = __webpack_require__(0);
...
var DelayedStream = __webpack_require__(34);
...
const util = __webpack_require__(0);
const Stream = __webpack_require__(1);
const ResponseBase = __webpack_require__(44);
...
const StringDecoder = __webpack_require__(46).StringDecoder;
const Stream = __webpack_require__(1);
const zlib = __webpack_require__(18);
...
const CookieJar = __webpack_require__(6).CookieJar;
const CookieAccess = __webpack_require__(6).CookieAccessInfo;
const parse = __webpack_require__(2).parse;
const request = __webpack_require__(7);
const AgentBase = __webpack_require__(56);
let methods = __webpack_require__(17);
...
const binary = __webpack_require__(61);
